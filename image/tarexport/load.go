...
func (l *tarexporter) loadLayer(filename string, rootFS image.RootFS, id string, foreignSrc *layer.ForeignSource, progressOutput progress.Output) (layer.Layer, error) {
